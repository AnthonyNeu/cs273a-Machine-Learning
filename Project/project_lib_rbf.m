...
% title('influence of gamma on libsvm with rbf kernel');
...
ylabel('MSE');
legend('Train Error','Test Error');
title('influence of cost C on libsvm with rbf kernel');
